...
public readonly partial struct Pkcs11ECCurve
{
    ...
    public static class NamedCurves
    {
        ...
        [Obsolete("P-192 provides ~96-bit security, below the 112-bit floor (NIST SP 800-57) and removed from FIPS 186-5. Use NistP256 or stronger. " +
                  "Pkcs11Workspace.GenerateEcKeyPair throws CryptoPolicyViolationException unless a policy that permits it (e.g. Pkcs11Workspace.UsePolicy(CryptoPolicy.AllowInsecure)) is in effect.",
        ...
        public static Pkcs11ECCurve NistP256 { get; } = CreateFromValue(NistP256Oid, "nistP256");
        /// <summary>NIST P-384 / secp384r1.</summary>
        public static Pkcs11ECCurve NistP384 { get; } = CreateFromValue(NistP384Oid, "nistP384");
        /// <summary>NIST P-521 / secp521r1.</summary>
        public static Pkcs11ECCurve NistP521 { get; } = CreateFromValue(NistP521Oid, "nistP521");
        ...
        public static Pkcs11ECCurve Secp256k1 { get; } = CreateFromValue(Secp256k1Oid, "secp256k1");
        ...
        public static Pkcs11ECCurve BrainpoolP256r1 { get; } = CreateFromValue(BrainpoolP256r1Oid, "brainpoolP256r1");
        /// <summary>brainpoolP256t1.</summary>
        public static Pkcs11ECCurve BrainpoolP256t1 { get; } = CreateFromValue(BrainpoolP256t1Oid, "brainpoolP256t1");
        /// <summary>brainpoolP320r1.</summary>
        public static Pkcs11ECCurve BrainpoolP320r1 { get; } = CreateFromValue(BrainpoolP320r1Oid, "brainpoolP320r1");
        /// <summary>brainpoolP320t1.</summary>
        public static Pkcs11ECCurve BrainpoolP320t1 { get; } = CreateFromValue(BrainpoolP320t1Oid, "brainpoolP320t1");
        /// <summary>brainpoolP384r1.</summary>
        public static Pkcs11ECCurve BrainpoolP384r1 { get; } = CreateFromValue(BrainpoolP384r1Oid, "brainpoolP384r1");
        /// <summary>brainpoolP384t1.</summary>
        public static Pkcs11ECCurve BrainpoolP384t1 { get; } = CreateFromValue(BrainpoolP384t1Oid, "brainpoolP384t1");
        /// <summary>brainpoolP512r1.</summary>
        public static Pkcs11ECCurve BrainpoolP512r1 { get; } = CreateFromValue(BrainpoolP512r1Oid, "brainpoolP512r1");
        /// <summary>brainpoolP512t1.</summary>
        public static Pkcs11ECCurve BrainpoolP512t1 { get; } = CreateFromValue(BrainpoolP512t1Oid, "brainpoolP512t1");

        /// <summary>SM2 (GB/T 32918), OID 1.2.156.10197.1.301.</summary>
        public static Pkcs11ECCurve Sm2 { get; } = CreateFromValue(Sm2Oid, "sm2");
    }

    // OID constants for every catalog curve, each referenced from more than one table below
    // (NamedCurves, _namesByOid, _fieldSizeBitsByOid, and — for the below-baseline curves —
    // _belowBaselineOids) — avoids repeating the literal.
    ...
    private const string BrainpoolP256t1Oid = "1.3.36.3.3.2.8.1.1.8";
    private const string BrainpoolP320r1Oid = "1.3.36.3.3.2.8.1.1.9";
    private const string BrainpoolP320t1Oid = "1.3.36.3.3.2.8.1.1.10";
    private const string BrainpoolP384r1Oid = "1.3.36.3.3.2.8.1.1.11";
    private const string BrainpoolP384t1Oid = "1.3.36.3.3.2.8.1.1.12";
    private const string BrainpoolP512r1Oid = "1.3.36.3.3.2.8.1.1.13";
    private const string BrainpoolP512t1Oid = "1.3.36.3.3.2.8.1.1.14";
    private const string Sm2Oid = "1.2.156.10197.1.301";
    ...
    private static readonly Dictionary<string, string> _namesByOid = new(StringComparer.Ordinal)
    {
        ...
        [BrainpoolP256t1Oid] = "brainpoolP256t1",
        [BrainpoolP320r1Oid] = "brainpoolP320r1",
        [BrainpoolP320t1Oid] = "brainpoolP320t1",
        [BrainpoolP384r1Oid] = "brainpoolP384r1",
        [BrainpoolP384t1Oid] = "brainpoolP384t1",
        [BrainpoolP512r1Oid] = "brainpoolP512r1",
        [BrainpoolP512t1Oid] = "brainpoolP512t1",
        [Sm2Oid] = "sm2",
    };
    ...
    private static readonly Dictionary<string, int> _fieldSizeBitsByOid = new(StringComparer.Ordinal)
    {
        ...
        [NistP256Oid] = 256,             // nistP256
        [NistP384Oid] = 384,             // nistP384
        [NistP521Oid] = 521,             // nistP521
        [Secp192k1Oid] = 192,            // secp192k1
        [Secp224k1Oid] = 224,            // secp224k1
        [Secp256k1Oid] = 256,            // secp256k1
        ...
        [BrainpoolP256r1Oid] = 256,      // brainpoolP256r1
        [BrainpoolP256t1Oid] = 256,      // brainpoolP256t1
        [BrainpoolP320r1Oid] = 320,      // brainpoolP320r1
        [BrainpoolP320t1Oid] = 320,      // brainpoolP320t1
        [BrainpoolP384r1Oid] = 384,      // brainpoolP384r1
        [BrainpoolP384t1Oid] = 384,      // brainpoolP384t1
        [BrainpoolP512r1Oid] = 512,      // brainpoolP512r1
        [BrainpoolP512t1Oid] = 512,      // brainpoolP512t1
        [Sm2Oid] = 256,                  // sm2
    };

    // Catalog curves providing < 128-bit security (field size < 256-bit): the 160/192/224-bit NIST
    // and Brainpool curves. GenerateEcKeyPair gates these behind the workspace's crypto policy. See IsBelowSecurityBaseline.
