...
public sealed class CkmX2RatchetRespondParams : MechanismParameters
{
    ...
    /// </param>
    public CkmX2RatchetRespondParams(ReadOnlySpan<byte> sk, ulong ownPrekey, ulong initiatorIdentity, ulong ownPublicIdentity, bool encryptedHeader, ulong curve, CKM aeadMechanism, CKM kdfMechanism)
    {
