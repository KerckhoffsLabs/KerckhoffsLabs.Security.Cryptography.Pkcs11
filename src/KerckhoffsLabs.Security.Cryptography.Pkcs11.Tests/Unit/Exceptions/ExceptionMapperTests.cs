...
{
    public static TheoryData<CKR> AuthenticationCases() =>
    [
    ...
    public static TheoryData<CKR> SessionCases() =>
    [
    ...
    public static TheoryData<CKR> TokenCases() =>
    [
    ...
    public static TheoryData<CKR> MechanismCases() =>
    [
    ...
    public static TheoryData<CKR> ObjectCases() =>
    [
    ...
    public static TheoryData<CKR> ArgumentCases() =>
    [
