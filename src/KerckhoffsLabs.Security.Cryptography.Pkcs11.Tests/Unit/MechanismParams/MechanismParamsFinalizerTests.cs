...
public sealed class MechanismParamsFinalizerTests
{
    ...
    private static WeakReference[] CreateUndisposed()
    {
        ...
        [
            ...
            new CkmSp800108CounterKdfParams(CKM.CKM_SHA256_HMAC, new byte[2], new byte[2]),
            new CkmSp800108FeedbackKdfParams(CKM.CKM_SHA256_HMAC, dataParams: IntPtr.Zero, numberOfDataParams: 3, new byte[8]),
            new CkmSp800108KdfParams(CKM.CKM_SHA256_HMAC, dataParams: IntPtr.Zero, numberOfDataParams: 5),
