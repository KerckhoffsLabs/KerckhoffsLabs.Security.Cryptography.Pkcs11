...
/// <summary>HMACPkcs11 over Kryoptic — thin wrapper over <see cref="HMACPkcs11TestCases"/>.</summary>
[Collection("Kryoptic")]
public sealed class HMACPkcs11Tests_Kryoptic(KryopticBackendFixture backend)
{
