...
/// <summary>AesGcmPkcs11 over NSS — thin wrapper over <see cref="AesGcmPkcs11TestCases"/>.</summary>
[Collection("Nss")]
public sealed class AesGcmPkcs11Tests_Nss(NssBackendFixture backend)
{
