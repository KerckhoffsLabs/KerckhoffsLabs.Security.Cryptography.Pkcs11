...
/// <summary>AesGcmPkcs11 over Kryoptic — thin wrapper over <see cref="AesGcmPkcs11TestCases"/>.</summary>
[Collection("Kryoptic")]
public sealed class AesGcmPkcs11Tests_Kryoptic(KryopticBackendFixture backend)
{
