...
/// <summary>ChaCha20Poly1305Pkcs11 over Kryoptic — thin wrapper over <see cref="ChaCha20Poly1305Pkcs11TestCases"/>.</summary>
[Collection("Kryoptic")]
public sealed class ChaCha20Poly1305Pkcs11Tests_Kryoptic(KryopticBackendFixture backend)
{
    ...
    [ConditionalTheory(typeof(KryopticBackendFixture), nameof(KryopticBackendFixture.KryopticAvailable))]
    [InlineData(8)]
    [InlineData(13)]
