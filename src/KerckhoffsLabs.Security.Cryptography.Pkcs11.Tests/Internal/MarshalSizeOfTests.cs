...
public sealed class MarshalSizeOfTests
{
    ...
    /// These run on ANY platform (the IL layout is baked at compile time).
    /// </summary>
    [Theory]
    ...
    [InlineData("CK_INTERFACE_Windows", 24)]
    [InlineData("CK_MECHANISM_INFO_Windows", 24)]
    [InlineData("CK_MECHANISM_Windows", 24)]
    ...
    [InlineData("CK_CAMELLIA_CBC_ENCRYPT_DATA_PARAMS_Windows", 32)]
    [InlineData("CK_CAMELLIA_CTR_PARAMS_Windows", 24)]
    [InlineData("CK_CCM_MESSAGE_PARAMS_Windows", 56)]
    [InlineData("CK_CCM_PARAMS_Windows", 48)]
    [InlineData("CK_CCM_WRAP_PARAMS_Windows", 64)]
    [InlineData("CK_CHACHA20_PARAMS_Windows", 32)]
    [InlineData("CK_CMS_SIG_PARAMS_Windows", 64)]
    [InlineData("CK_DERIVED_KEY_Windows", 24)]
    [InlineData("CK_DES_CBC_ENCRYPT_DATA_PARAMS_Windows", 24)]
    [InlineData("CK_DSA_PARAMETER_GEN_PARAM_Windows", 32)]
    [InlineData("CK_ECDH_AES_KEY_WRAP_PARAMS_Windows", 32)]
    [InlineData("CK_ECDH1_DERIVE_PARAMS_Windows", 40)]
    [InlineData("CK_ECDH2_DERIVE_PARAMS_Windows", 72)]
    [InlineData("CK_ECMQV_DERIVE_PARAMS_Windows", 80)]
    [InlineData("CK_EDDSA_PARAMS_Windows", 17)]
    [InlineData("CK_EXTRACT_PARAMS_Windows", 8)]
    [InlineData("CK_GCM_MESSAGE_PARAMS_Windows", 48)]
    [InlineData("CK_GCM_PARAMS_Windows", 48)]
    [InlineData("CK_GCM_WRAP_PARAMS_Windows", 56)]
    [InlineData("CK_GOSTR3410_DERIVE_PARAMS_Windows", 40)]
    [InlineData("CK_GOSTR3410_KEY_WRAP_PARAMS_Windows", 40)]
    [InlineData("CK_HASH_SIGN_ADDITIONAL_CONTEXT_Windows", 32)]
    [InlineData("CK_HKDF_PARAMS_Windows", 58)]
    [InlineData("CK_IKE_PRF_DERIVE_PARAMS_Windows", 50)]
    [InlineData("CK_IKE1_EXTENDED_DERIVE_PARAMS_Windows", 33)]
    [InlineData("CK_IKE1_PRF_DERIVE_PARAMS_Windows", 58)]
    [InlineData("CK_IKE2_PRF_PLUS_DERIVE_PARAMS_Windows", 33)]
    [InlineData("CK_KEA_DERIVE_PARAMS_Windows", 41)]
    [InlineData("CK_KEY_DERIVATION_STRING_DATA_Windows", 16)]
    [InlineData("CK_KEY_WRAP_SET_OAEP_PARAMS_Windows", 17)]
    [InlineData("CK_KIP_PARAMS_Windows", 32)]
    [InlineData("CK_MAC_GENERAL_PARAMS_Windows", 8)]
    [InlineData("CK_OTP_PARAM_Windows", 24)]
    [InlineData("CK_OTP_PARAMS_Windows", 16)]
    [InlineData("CK_OTP_SIGNATURE_INFO_Windows", 16)]
    [InlineData("CK_PBE_PARAMS_Windows", 48)]
    [InlineData("CK_PKCS5_PBKD2_PARAMS_Windows", 72)]
    [InlineData("CK_PKCS5_PBKD2_PARAMS2_Windows", 72)]
    [InlineData("CK_PRF_DATA_PARAM_Windows", 24)]
    [InlineData("CK_RC2_CBC_PARAMS_Windows", 16)]
    [InlineData("CK_RC2_MAC_GENERAL_PARAMS_Windows", 16)]
    [InlineData("CK_RC2_PARAMS_Windows", 8)]
    [InlineData("CK_RC5_CBC_PARAMS_Windows", 32)]
    [InlineData("CK_RC5_MAC_GENERAL_PARAMS_Windows", 24)]
    [InlineData("CK_RC5_PARAMS_Windows", 16)]
    [InlineData("CK_RSA_AES_KEY_WRAP_PARAMS_Windows", 16)]
    [InlineData("CK_RSA_PKCS_OAEP_PARAMS_Windows", 40)]
    [InlineData("CK_RSA_PKCS_PSS_PARAMS_Windows", 24)]
    [InlineData("CK_SALSA20_CHACHA20_POLY1305_MSG_PARAMS_Windows", 24)]
    [InlineData("CK_SALSA20_CHACHA20_POLY1305_PARAMS_Windows", 32)]
    [InlineData("CK_SALSA20_PARAMS_Windows", 24)]
    [InlineData("CK_SEED_CBC_ENCRYPT_DATA_PARAMS_Windows", 32)]
    [InlineData("CK_SIGN_ADDITIONAL_CONTEXT_Windows", 24)]
    [InlineData("CK_SKIPJACK_PRIVATE_WRAP_PARAMS_Windows", 88)]
    [InlineData("CK_SKIPJACK_RELAYX_PARAMS_Windows", 112)]
    [InlineData("CK_SP800_108_COUNTER_FORMAT_Windows", 9)]
    [InlineData("CK_SP800_108_DKM_LENGTH_FORMAT_Windows", 17)]
    [InlineData("CK_SP800_108_FEEDBACK_KDF_PARAMS_Windows", 56)]
    [InlineData("CK_SP800_108_KDF_PARAMS_Windows", 40)]
    [InlineData("CK_SSL3_KEY_MAT_OUT_Windows", 48)]
    [InlineData("CK_SSL3_KEY_MAT_PARAMS_Windows", 65)]
    [InlineData("CK_SSL3_MASTER_KEY_DERIVE_PARAMS_Windows", 40)]
    [InlineData("CK_SSL3_RANDOM_DATA_Windows", 32)]
    [InlineData("CK_TLS_KDF_PARAMS_Windows", 72)]
    [InlineData("CK_TLS_MAC_PARAMS_Windows", 24)]
    [InlineData("CK_TLS_PRF_PARAMS_Windows", 48)]
    [InlineData("CK_TLS12_EXTENDED_MASTER_KEY_DERIVE_PARAMS_Windows", 32)]
    [InlineData("CK_TLS12_KEY_MAT_PARAMS_Windows", 73)]
    [InlineData("CK_TLS12_MASTER_KEY_DERIVE_PARAMS_Windows", 48)]
    [InlineData("CK_WTLS_KEY_MAT_OUT_Windows", 24)]
    [InlineData("CK_WTLS_KEY_MAT_PARAMS_Windows", 81)]
    [InlineData("CK_WTLS_MASTER_KEY_DERIVE_PARAMS_Windows", 48)]
    [InlineData("CK_WTLS_PRF_PARAMS_Windows", 56)]
    [InlineData("CK_WTLS_RANDOM_DATA_Windows", 32)]
    [InlineData("CK_X2RATCHET_INITIALIZE_PARAMS_Windows", 57)]
    [InlineData("CK_X2RATCHET_RESPOND_PARAMS_Windows", 57)]
    [InlineData("CK_X3DH_INITIATE_PARAMS_Windows", 56)]
    [InlineData("CK_X3DH_RESPOND_PARAMS_Windows", 48)]
    [InlineData("CK_X9_42_DH1_DERIVE_PARAMS_Windows", 40)]
    [InlineData("CK_X9_42_DH2_DERIVE_PARAMS_Windows", 72)]
    [InlineData("CK_X9_42_MQV_DERIVE_PARAMS_Windows", 80)]
    [InlineData("CK_XEDDSA_PARAMS_Windows", 8)]
    // END PROBED Windows InlineData
